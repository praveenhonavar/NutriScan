...
- The JSON response recieved from the ML Vision API containing the name of food item is referenced with the [Food API](https://api.nal.usda.gov/fdc) databse to get nutritional facts.


![Nutriscan](https://github.com/praveenhonavar/NutriScan/blob/master/Screenshots1/Group%201.png)